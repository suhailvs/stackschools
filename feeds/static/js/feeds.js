...
$(function () {
  ...
  function check_new_feeds () {
    ...
    if (last_feed != undefined) {
      $.ajax({
        ...
        complete: function() {
          window.setTimeout(check_new_feeds, setTimeoutDuration);
        }
      });
    }
    else {
  ...
  function update_feeds () {
    ...
    if (first_feed != undefined && last_feed != undefined) {
      $.ajax({
        ...
        complete: function () {
          window.setTimeout(update_feeds, setTimeoutDuration);
        }
      });
    }
    else {
  ...
  function track_comments () {
    ...
    window.setTimeout(track_comments, setTimeoutDuration);
  };
  track_comments();
